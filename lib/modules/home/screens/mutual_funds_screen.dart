...
class _MutualFundsScreenState extends State<MutualFundsScreen> {
        ...
        Row(
          ...
          children: [
            Text(
              ...
              style: TextStyle(color: isProfit ? Colors.greenAccent : Colors.redAccent, fontWeight: FontWeight.bold)
            ),
             const SizedBox(width: 4),
            Text(
              "($percentage)",
              style: TextStyle(color: isProfit ? Colors.greenAccent.withOpacity(0.8) : Colors.redAccent.withOpacity(0.8), fontSize: 10),
            ),
          ],
        )
      ],
                  ...
                  PieChartData(
                    ...
                    sections: portfolio.holdings.asMap().entries.map((entry) {
                      ...
                      return PieChartSectionData(
                        ...
                        badgeWidget: isTouched ? _buildTouchBadge(h.schemeName) : null,
  ...
  Widget _buildPerformanceChart(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Portfolio Growth (1Y)", style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
        const SizedBox(height: 16),
        Container(
          height: 250,
